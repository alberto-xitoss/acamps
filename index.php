...
{
	/* Foi adicionado o ambiente "acamps", que representa a aplicação
	 * rodando durante o Acampamento, onde não haverá pasta de missão e a aplicação
	 * será acessada diretamente pelo endereço "endereço_do_servidor/acamps/",
	 * ao invés de "endereço_do_servidor/acamps/missao/".
	 */
