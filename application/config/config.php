...
if(ENVIRONMENT == 'development'){
	$config['base_url'] = "URL para a aplica��o no servidor de desenvolvimento";
	//Recomendado: $config['base_url']	= 'http://localhost/acamps/'.MISSAO_DIR.'/';
	
}elseif(ENVIRONMENT == 'production'){
	$config['base_url'] = "URL para a aplica��o na internet";
	//Recomendado: $config['base_url']	= 'http://'.$_SERVER['SERVER_NAME'].'/acamps/'.MISSAO_DIR.'/';
	
}elseif(ENVIRONMENT == 'acamps'){
	$config['base_url'] = "URL para a aplica��o durante o Acampamento";
