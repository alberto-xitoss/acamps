...
if(ENVIRONMENT == 'development'){
	$config['base_url'] = "URL para a aplicaзгo no servidor de desenvolvimento";
	//Recomendado: $config['base_url']	= 'http://localhost/acamps/'.MISSAO_DIR.'/';
	
}elseif(ENVIRONMENT == 'production'){
	$config['base_url'] = "URL para a aplicaзгo na internet";
	//Recomendado: $config['base_url']	= 'http://'.$_SERVER['SERVER_NAME'].'/acamps/'.MISSAO_DIR.'/';
	
}elseif(ENVIRONMENT == 'acamps'){
	$config['base_url'] = "URL para a aplicaзгo durante o Acampamento";
...
$config['csrf_token_name'] = 'acamps_sec';
$config['csrf_cookie_name'] = 'acamps_sec';
