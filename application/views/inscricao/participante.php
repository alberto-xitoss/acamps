...
<hr>
	...
	<div class="clearfix">
		...
		<div class="input">
			<ul class="inputs-list">
				<li><label for="bl_fez_comunhao_s"><input type="radio" class="obrigatorio" id="bl_fez_comunhao_s" value="1" name="bl_fez_comunhao" <?php if(set_radio('bl_fez_comunhao', '1')) echo 'checked' ?>>Sim</label></li>
				<li><label for="bl_fez_comunhao_n"><input type="radio" class="obrigatorio" id="bl_fez_comunhao_n" value="0" name="bl_fez_comunhao" <?php if(set_radio('bl_fez_comunhao', '0')) echo 'checked' ?>>Não</label></li>
			</ul>
		</div>
	</div>
	<!-- Fazer 1ª Eucaristia? -->
