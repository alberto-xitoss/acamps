...
<?php echo form_open_multipart('inscricao/servico'); ?>
    ...
    <p>
    <?php
	echo form_label('Serviço','',array('class'=>'campo'));
	?>
    </p>
    <p>
    <?php
    echo form_dropdown('id_servico', $servicos, $this->input->post('id_servico'), 'class="obrigatorio"');
    ?>
    </p>
    ...
    <p>
    <?php
    $cidades = array_merge(array('0'=>'Selecione...'), $cidades);
    echo form_label('Cidade','',array('class'=>'campo'));
	?>
    </p>
    <p>
    <?php
