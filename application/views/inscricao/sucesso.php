...
Número de Inscrição: <span class="highlight"><?php echo $id_pessoa ?></span></p>

<p class="alert alert-success"><strong>IMPORTANTE - Guarde o número de sua inscrição!</strong></p>
...
<?php if($cd_tipo != 'v'): ?>
	...
	<p class="alert alert-info alert-block">Quando for pagar sua inscrição é necessário que você leve um documento com foto.<br/>
