...
<h2>Formulário de Inscrição - Comunidade de Vida</h2>
    ...
    <?php endif; ?>
<?php echo form_open_multipart('admin/inscrever/cv', array('class'=>'form-horizontal')); ?>
...
<div class="importante">
	...
	<div class="control-group">
		...
		<div class="controls"><?php echo form_dropdown('id_setor', $setores, $this->input->post('id_setor')); ?></div>
	</div>
	<!-- Serviço -->
	<div class="control-group">
