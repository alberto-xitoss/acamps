...
<div class="importante">
	...
	<p>
    <?php echo form_label('O que fará no período da tarde?','',array('class'=>'campo'));
    echo form_radio(array(
        'name'=>'bl_seminario',
        'id'=>'bl_seminario_s',
        'value'=>'1',
    ...
    <p>
    <?php echo form_label('Já fez primeira eucaristia?','',array('class'=>'campo'));
	echo form_radio(array(
    ...
    <p>
    <?php echo form_label('Deseja fazer?','',array('class'=>'campo'));
	echo form_radio(array(
