 ...
 *
 * ALTERAÇÃO: Foi adicionado o ambiente "acamps", que representa a aplicação
 * rodando durante o Acampamento, onde não haverá pasta de missão e a aplicação
 * será acessada diretamente pelo endereço "servidor/acamps/", ao invés de "servidor/acamps/missao/".
 *
 */
	
	// Em geral este valor 'localhost' não precisará ser mudado.
	if($_SERVER['SERVER_NAME'] == 'localhost'){
		define('ENVIRONMENT', 'development');
		
	// Se você não pretende colocar a aplicação na internet, não se preocupe com essa configuração.
	}elseif($_SERVER['SERVER_NAME'] == 'NomeDoServidor.com'){
		define('ENVIRONMENT', 'production');
		
	}else{
		// Essa condição será alcançada se o servidor estiver sendo acessado através de seu endereço IP
		define('ENVIRONMENT', 'acamps');
	}
 ...
 */
	...
	define('MISSAO_ID',0); // Deve conter o id do registro na tabela 'missao'
